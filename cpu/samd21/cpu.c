...
/**
 * @name   Default Clock configurations
 * @{
 */
...
/**
 * @brief setup 1 MHz (8MHz clock/8) clock on Generic Clock Generator 1
 */
 ...
 */
static bool is_enabled_gen2_xosc32 = false;
